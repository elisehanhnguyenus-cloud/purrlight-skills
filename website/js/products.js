...
const PRODUCTS = [
  ...
  {
    id: "cat-pvc-keychain",
    name: "Moon Cat PVC Keychain",
    category: "Keychains",
    price: 12,
    badge: "new",
    img: "assets/img/product-keychain-cat.svg",
    short: "Our little mascot — a curled cat under a crescent moon, in soft-touch PVC.",
    desc: "The Purrlight moon cat, cast in flexible soft-touch PVC with a matte finish. Sturdy enough for daily keys, cute enough to make you smile at the door.",
    details: ["Soft-touch PVC charm", "About 2.5\" / 6 cm", "Metal keyring hardware", "Wipe clean"],
    etsyUrl: ""
  },
  {
    id: "crochet-cat",
    name: "Sleepy Crochet Cat Plush",
    category: "Dolls & Plush",
    price: 34,
    badge: "made-to-order",
  ...
  },
  {
    ...
    short: "Our moon-cat artwork on a tee made for evening people.",
    desc: "A quiet little graphic — whiskers, a crescent moon, a scatter of stars — from the same sketchbook as our logo. Printed to order on a soft unisex tee.",
    details: ["Soft cotton-blend tee", "Unisex sizes S–3XL — see size chart", "Printed to order", "Machine wash cold, inside out"],
    etsyUrl: ""
  },
  {
